...
$query="select Pname,price,time,days,userName from users inner join package on users.package_name = package.Pname ORDER BY package_name ASC ";
...
$stmt=mysqli_stmt_init($conn);
 ...
 mysqli_stmt_bind_result($stmt,$Pname,$price,$time,$days,$user) or exit('Result storage failed.'. mysqli_stmt_errno($stmt));

echo '<table border="1"><tr><th>Name</th><th>price</th><th>time</th><th>days</th><th>users</th></tr>';
